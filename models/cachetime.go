...
type CacheTime struct {
	...
	CollectionTitle string     `bson:"collection_title,omitempty" json:"collection_title,omitempty"` // Collection title - used for describing the collection in a human-readable format
