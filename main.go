...
const serviceName = "dp-legacy-cache-api"
...
func run(ctx context.Context) error {
	...
	log.Info(ctx, "dp-legacy-cache-api version", log.Data{"version": Version})
	...
	err = cacheService.Run(ctx, cfg, svcList, BuildTime, GitCommit, Version, svcErrors)
	if err != nil {
